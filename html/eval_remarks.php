    ...
    <body>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-hover display nowrap" style="width:100%;" id="grade_remarks_tbl">
                                                    ...
                                                    if($fetch){
                                                        ...
                                                        if($count > 0){
                                                            ...
                                                            while($row = mysqli_fetch_assoc($fetch)){
                                                                ...
                                                                echo "<tr>";
                                                                echo "<td class='font-weight-bold'>".$grade_remark."</td>";
                                                                echo "<td class='font-weight-bold text-center'>
                                                                        <span 
                                                                ...
                                                                echo "<td>
                                                                        ...
                                                                        <button 
                                                                            ...
                                                                            onclick='deleteGradeRemark(`".$grade_remark_Id."`)'>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card" style="position:sticky; top:0;">
                                ...
                                <form method="POST" id="newGradeRemarkForm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <p><b>Remark Name: <span class="text-danger">(*)</span></b></p>
                                            <input 
                                                type="text" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p><b>Color Indicator: <span class="text-muted">(Optional)</span></b></p>

                                            <div class="d-flex align-items-center">
    
                                                <h4><span 
                                                    class="fa fa-circle text-success mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#color_ind_val').val('text-success')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-info mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#color_ind_val').val('text-info')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-warning mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#color_ind_val').val('text-warning')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-danger mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#color_ind_val').val('text-danger')"></span></h4>

                                                <input type="hidden" name="color_ind_val" id="color_ind_val" >
                                ...
                                <form method="POST" id="editGradeRemarkForm" style="display:none;">

                                    <div class="card-header bg-white">
                                        <h4 class="font-weight-bold text-uppercase">Edit Evaluation Remark </h4>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input 
                                            type="hidden" 
                                            class="form-control form-control-sm"
                                            name="e_grade_remark_Id" 
                                            id="e_grade_remark_Id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h4><span 
                                                    class="fa fa-circle text-success mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#e_color_ind_val').val('text-success')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-info mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#e_color_ind_val').val('text-info')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-warning mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#e_color_ind_val').val('text-warning')"></span></h4>
    
                                                <h4><span 
                                                    class="fa fa-circle text-danger mr-3" 
                                                    style="cursor:pointer;" 
                                                    onclick="$('#e_color_ind_val').val('text-danger')"></span></h4>

                                                <input type="hidden" name="e_color_ind_val" id="e_color_ind_val" >
                                    ...
                                    <div class="card-footer bg-white text-right">
                                        ...
                                        <button 
                                            ...
                                            onclick="
                                                $('#editGradeRemarkForm').hide()
                                                $('#newGradeRemarkForm').show()
                                            ">
                                            Discard
                                        </button>
                                    </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#newGradeRemarkForm').on('submit', function(aa){
                    ...
                    data.push(
                        { name:'action', value:'new_grade_remark'}
                    )
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response == 1){
                                ...
                                toastr.success('You added a new evaluation remark', 'SAVED SUCCESSFULLY')
                ...
                $('#editGradeRemarkForm').on('submit', function(ab){
                    ...
                    data.push(
                        { name:'action', value:'edit_grade_remark' }
                    )
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response == 1){
                                ...
                                toastr.success('You updated an evaluation remark', 'SAVED SUCCESSFULLY')
            ...
            function gradeRemarksTbl(){

                $('#grade_remarks_tbl').DataTable({
            ...
            function deleteGradeRemark(remark_Id){
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response == 1){
                                    ...
                                    toastr.success('You deleted an evaluation remark. Refreshing the page.', 'REMOVED SUCCESSFULLY')
