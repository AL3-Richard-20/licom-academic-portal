                            ...
                            <form class="form-horizontal r-separator">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">First Name</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                            <input type="text" class="form-control" id="inputEmail3" placeholder="First Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Last Name</label> 
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                            <input type="text" class="form-control" id="inputEmail3" placeholder="Last Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                            <input type="email" class="form-control" id="inputEmail3" placeholder="Email Here">
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Contact No</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Company</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                            <input type="text" class="form-control" id="inputEmail3" placeholder="Company Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Interested In</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                    ...
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Budget</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                            <select class="form-control">
                                                <option>Choose Your Option</option>
                                    ...
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">About Project</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                            ...
                            <form class="form-horizontal r-separator">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Nick Name</label>
                                                <div class="col-9 border-left p-b-10 p-t-10">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="row border-bottom">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Website</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Bio</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal r-separator">
                                <div class="card-body">
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Full Name</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
                                    ...
                                    <div class="form-group row align-items-center m-b-0">
                                        <label for="inputEmail3" class="col-3 text-right control-label col-form-label">Existing Customer</label>
                                        <div class="col-9 border-left p-b-10 p-t-10">
