                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-15">
                                    <div id="editor2" contenteditable="true" class="inline-editor">
                                        <p>
                                            This <a href="https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_inline">inline editor</a> instance is using the&nbsp;<a href="https://ckeditor.com/cke4/addon/sourcedialog">Source Dialog</a>&nbsp;plugin for source editing.
                                        </p>
                                        <p>
                                        ...
                                        <ul>
                                            <li>
                                                Click the&nbsp;<strong>Source&nbsp;</strong>button to display the HTML source of this text in the Source dialog window.
                                            </li>
                                            <li>
