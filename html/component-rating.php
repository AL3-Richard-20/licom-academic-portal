            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Number Of Stars</h4>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Number Max</h4>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">No Rated Message</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Star Half</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Icon Range</h4>
                                <p>Change the maximum of stars that can be created.</p>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Round Figure Enabled</h4>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Round Figure Disabled</h4>
                                <ul class="list-style-none m-b-20">
