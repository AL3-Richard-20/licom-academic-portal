            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Right Timeline</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="timeline timeline-right">
                                    ...
                                    <li class="timeline-item">
                                        <div class="timeline-badge warning"><img class="img-fluid" src="../../assets/images/users/2.jpg" alt="img"> </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4 class="timeline-title">Ritesh Deshmukh</h4>
                                            </div>
                                            <div class="timeline-body">
                                                <p><img class="img-fluid" alt="user" src="../../assets/images/users/3.jpg"></p>
