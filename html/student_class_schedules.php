    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-right">
                            <button 
                                type="button" 
                                class="btn btn-dark btn-sm font-weight-bold text-uppercase" 
                                id="dl_sched_btn" 
                                onclick="downloadScheduleXlsx()"
                                disabled>
                                <span class="fa fa-download"></span>
                                &nbspDownload Schedule
                            </button>
                        </div>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(total_schedules > 0){
                            ...
                            $('#dl_sched_btn').prop('disabled', false)
                        }
                        else{

                            $('#dl_sched_btn').prop('disabled', true)
                        }
            ...
            function downloadScheduleXlsx(){
                ...
                window.open('export_schedules_xlsx.php?semesterid='+ semester_Id +'&roomid='+room_Id)
