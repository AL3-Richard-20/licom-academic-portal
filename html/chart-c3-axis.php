...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">C3 Axis Chart</h4>
    ...
    <!-- Charts JS -->
    <script src="../dist/js/pages/c3-chart/axis/c3-rotated-axis.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-category-axis.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-tick-culling.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-tick-fitting.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-timezone.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-y-axis.js"></script>
    <script src="../dist/js/pages/c3-chart/axis/c3-y-axis-range.js"></script>
